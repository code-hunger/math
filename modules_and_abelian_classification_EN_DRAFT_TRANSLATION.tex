...
\begin{proof}
    ...
    pairwise, they are \quotedblbase parallel,\quotedblright{} and in each subsequent pair, the unit
    vector of the submodule is proportionally longer than that of the previous pair.

    We begin with (one) \quotedblbase shortest\quotedblright{} coordinate axis. We examine all
    possible linear functionals $\Hom(M, R)$ and choose one that \quotedblbase
    preserves\quotedblright{} the most information about the submodule $M'$.
